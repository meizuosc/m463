...
#define ST480_DEFAULT_DELAY   100
 ...
 * Debug
 */
#define SENODIA_DEBUG_MSG       1
#define SENODIA_DEBUG_FUNC      1

#if SENODIA_DEBUG_MSG
#define SENODIADBG(format, ...) printk(KERN_EMERG "SENODIA " format "\n", ## __VA_ARGS__)
#else
#define SENODIADBG(format, ...)
#endif

#if SENODIA_DEBUG_FUNC
#define SENODIAFUNC(func) printk(KERN_EMERG "SENODIA " func " is called\n")
#else
