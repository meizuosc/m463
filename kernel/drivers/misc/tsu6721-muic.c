...
//#define GPIO_MUIC_EINT_PIN  (GPIO117 | 0x80000000)
//#define CUST_EINT_MUIC_TSU6721_NUM  6
...
{       /*configure to GPIO function, external interrupt*/
    /*
        mt_set_gpio_mode(GPIO_MUIC_EINT_PIN, GPIO_MUIC_EINT_PIN_M_EINT);
        ...
        mt_eint_set_hw_debounce(CUST_EINT_MUIC_TSU6721_NUM, CUST_EINT_MUIC_TSU6721_DEBOUNCE_CN);
        mt_eint_registration(CUST_EINT_MUIC_TSU6721_NUM, CUST_EINT_MUIC_TSU6721_TYPE, tsu6721_muic_isr, 0);
        mt_eint_unmask(CUST_EINT_MUIC_TSU6721_NUM);
    */
}
...
static int __init tsu6721_muic_init(void)
{
	...
	i2c_register_board_info(1, tsu6721_i2c_info, 1);
