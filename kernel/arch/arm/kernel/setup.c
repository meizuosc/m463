...
#else
#ifdef MEIZU_M79
	char rev_str[6] = {'M','4','6','5',' ','\0'};
#else
	char rev_str[6] = {'M','4','6','3',' ','\0'};
#endif
	printk(KERN_EMERG "system_rev: 0x%X\n", system_rev);
	switch (system_rev & 0x000F) {
	/* (463)0: domain official */
	case 0:
		rev_str[4] = '0';
		break;

	/* (463)1: china unicom customize */
	case 1:
		rev_str[4] = 'U';
		break;

	/* (463)2: china mobile customize */
	case 2:
	/* (463)3: china mobile public */
	case 3:
	/* (463)A: aliyun */
	case 0xA:
		rev_str[4] = 'M';
