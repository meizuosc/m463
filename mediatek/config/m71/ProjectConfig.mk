...
CUSTOM_HAL_CAM_CAL=s5k3l2xxotp ov5670otp
...
CUSTOM_HAL_IMGSENSOR=s5k3l2xx_mipi_raw s5k3l2xxliteon_mipi_raw ov5670_mipi_raw ov5670film_mipi_raw ov5670tech_mipi_raw 

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS= dummy_lens bu64245
...
CUSTOM_HAL_MAIN_IMGSENSOR= s5k3l2xx_mipi_raw s5k3l2xxliteon_mipi_raw 
...
CUSTOM_HAL_SUB_IMGSENSOR=ov5670_mipi_raw ov5670film_mipi_raw ov5670tech_mipi_raw 
...
CUSTOM_KERNEL_CAM_CAL=s5k3l2xxotp ov5670otp
...
CUSTOM_KERNEL_IMGSENSOR= s5k3l2xx_mipi_raw s5k3l2xxliteon_mipi_raw ov5670_mipi_raw ov5670film_mipi_raw ov5670tech_mipi_raw 
...
CUSTOM_KERNEL_LENS=dummy_lens bu64245
...
CUSTOM_KERNEL_MAIN_IMGSENSOR=s5k3l2xx_mipi_raw s5k3l2xxliteon_mipi_raw 
...
CUSTOM_KERNEL_SUB_IMGSENSOR=ov5670_mipi_raw ov5670film_mipi_raw ov5670tech_mipi_raw 
...
CUSTOM_LK_LCM= s6d1fa2_fhd_dsi_cmd_m71_tps65132 nt35532_fhd_dsi_vdo_m71_tps65132
...
MTK_GET_BATTERY_ID_BY_PMICADC=yes
MTK_SWIP_AAC=no
...
CUSTOM_KERNEL_LCM= s6d1fa2_fhd_dsi_cmd_m71_tps65132 nt35532_fhd_dsi_vdo_m71_tps65132

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM= s6d1fa2_fhd_dsi_cmd_m71_tps65132 nt35532_fhd_dsi_vdo_m71_tps65132
...
#CREATE_PROJECT_INFO=20140924155951
MTK_BUILD_VERNO = ALPS.KK2.MP13.V1.16

#For MEIZU M71 project
MEIZU_M71 = yes

# preloader log switch, no: enable preloader uart log, yes: disable preloader log
MZ_DISABLE_PRELOADER_LOG = yes

# kernel printk to uart switch, no: enable kernel printk to uart, yes: disable kernel printk to uart
# note: this option is only available for eng build, in user build the kernel printk to uart is always disable by default
MZ_DISABLE_KERNEL_PRINTK_UART = yes
