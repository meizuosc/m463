...
#define MAXIMUM_NVRAM_CAMERA_PLINE_FILE_SIZE     (80000)
#define MAXIMUM_NVRAM_CAMERA_SHADING_FILE_SIZE      (80000) //BYTE 81920--> 16000 for meta tool limitation

#define MAXIMUM_CAMERA_SHADING_SIZE  (900000)
