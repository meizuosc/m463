...
#define BU64245IOC_T_MOVETO _IOW(BU64245_MAGIC,1,unsigned long)

#define BU64245IOC_T_SETINFPOS _IOW(BU64245_MAGIC,2,unsigned long)

#define BU64245IOC_T_SETMACROPOS _IOW(BU64245_MAGIC,3,unsigned long)

#ifdef LensdrvCM3
#define BU64245IOC_G_MOTORMETAINFO _IOR(BU64245_MAGIC,4,stBU64245_MotorMETAInfo)
#endif

#define BU64245IOC_T_SETPARA _IOW(BU64245_MAGIC,5,unsigned long)
