...
#define AF_DRVNAME "GAF008AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x48
#define PLATFORM_DRIVER_NAME "lens_actuator_gaf008af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_gaf008af"
...
inline static int getAFInfo(__user stGAF008AF_MotorInfo * pstMotorInfo)
{
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case GAF008AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stGAF008AF_MotorInfo *)(a_u4Param));
        break;
...
static int __init GAF008AF_i2C_init(void)
{
