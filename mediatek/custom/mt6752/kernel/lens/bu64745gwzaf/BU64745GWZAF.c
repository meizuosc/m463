...
//  *****************************************************
static void    I2C_func_PON______( ){
    I2C_write_FBAF( 0xFF, 0x8000 );
}

static void    I2C_func_POFF_____( ){
    I2C_write_FBAF( 0xFF, 0x0000 );
}

static void    I2C_func_DSP_START( ){
    I2C_write_FBAF( 0x7E, 0x0000 );
}

static void    I2C_func_CEF_WRITE( CL_UBYTE u08_adr, CL_UWORD u16_dat){
