...
static void OV16825MIPI_Sensor_video2(void) 
{
	...
	*/	
	...
	OV16825_write_cmos_sensor(0x3208, 0x10);
	OV16825_write_cmos_sensor(0x3208, 0xa0);
    //scaling for 1280x720(ratio=1.5)
    OV16825_write_cmos_sensor(0x3808,0x05);
    OV16825_write_cmos_sensor(0x3809,0x00);
    OV16825_write_cmos_sensor(0x380a,0x02);
    OV16825_write_cmos_sensor(0x380b,0xd0);
    OV16825_write_cmos_sensor(0x3810,0x00);
    OV16825_write_cmos_sensor(0x3811,0x0f);//;11
    OV16825_write_cmos_sensor(0x3812,0x00);
    OV16825_write_cmos_sensor(0x3813,0x02);//;04
    OV16825_write_cmos_sensor(0x4603,0x3c);//;60
    OV16825_write_cmos_sensor(0x5000,0xff);	
	OV16825_write_cmos_sensor(0x0100,0x01);
