...
extern void	ForceNotSwitchToD3(bool booted );
...
extern Set_Rst_Pin(void);
extern MHL_Power(bool enable);
extern Set_I2S_Pin(bool enable);
extern Set_DPI_Pin(bool enable);
...
static int hdmi_drv_audio_config(HDMI_AUDIO_FORMAT aformat) {return 0;}
static int hdmi_drv_video_enable(bool enable)  {return 0;}
//static int hdmi_drv_audio_enable(bool enable)  {return 0;}
