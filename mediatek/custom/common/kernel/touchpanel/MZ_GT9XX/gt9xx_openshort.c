...
#define MAX_LIMIT_KEY_GROUP1 3000		// key_val max limit
#define MIN_LIMIT_KEY_GROUP1 1100		// key_val min limit
#define UNIFORMITY_GROUP1 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP1 {\
0x00,0x00,0x03,0x00,0x05,0x0A,0x05,0x01,0x01,0x08,0x28,0x05,0x50,0x32,0x03,0x05,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x8C,0x2E,0x0E,0x36,0x32,\
0x31,0x0D,0x31,0x0D,0x00,0x99,0x33,0x1D,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x29,0x18,0x5A,0x94,0x50,0x02,0x00,0x0A,0x54,0x04,0xCB,0x1B,0x00,0xA5,\
0x23,0x14,0x87,0x2E,0x00,0x71,0x3D,0x00,0x63,0x4F,0x00,0x63,0x38,0x00,0x00,0x00,\
0xF5,0x4A,0x3A,0xFF,0xFF,0x27,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x67,\
0x00,0x00,0x00,0x00,0x00,0x00,0x04,0x11,0x03,0x14,0x50,0x00,0x00,0x00,0x00,0x28,\
...
0x1C,0x1D,0x1E,0x1F,0x20,0x21,0x22,0x24,0x26,0x28,0x29,0x2A,0x14,0x13,0x12,0x10,\
0x0F,0x0C,0x0A,0x08,0x06,0x04,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x76,0x01,\
}
#else //MEIZU_M71
#define MAX_LIMIT_VALUE_GROUP1 3500 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP1 1000		// screen min limit
#define MAX_LIMIT_KEY_GROUP1 3600		// key_val max limit
#define MIN_LIMIT_KEY_GROUP1 1100		// key_val min limit
#define UNIFORMITY_GROUP1 70 			// screen uniformity in percent
...
#define MAX_LIMIT_KEY_GROUP2 3000		// key_val max limit
#define MIN_LIMIT_KEY_GROUP2 1100		// key_val min limit
#define UNIFORMITY_GROUP2 70 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP2 {\
0x00,0x00,0x03,0x00,0x05,0x0A,0x05,0x01,0x01,0x08,0x28,0x05,0x50,0x32,0x03,0x05,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x8C,0x2E,0x0E,0x32,0x36,\
0x31,0x0D,0x31,0x0D,0x00,0x99,0x33,0x1D,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x29,0x18,0x5A,0x94,0x50,0x02,0x00,0x0A,0x54,0x04,0xD3,0x1B,0x00,0xA9,\
0x23,0x14,0x88,0x2E,0x00,0x6F,0x3D,0x00,0x5F,0x4F,0x00,0x5F,0x40,0x00,0x00,0x00,\
0xF5,0x4A,0x3A,0xFF,0xFF,0x27,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x67,\
0x00,0x00,0x00,0x00,0x00,0x00,0x04,0x11,0x03,0x14,0x50,0x00,0x00,0x00,0x00,0x28,\
0x02,0x04,0x06,0x08,0x0A,0x0C,0x0E,0x10,0x12,0x14,0x16,0x18,0x1A,0x1C,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x14,0x13,\
...
#else //MEIZU_M71
#define MAX_LIMIT_VALUE_GROUP2 3500 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP2 1000		// screen min limit
#define MAX_LIMIT_KEY_GROUP2 3600		// key_val max limit
#define MIN_LIMIT_KEY_GROUP2 1100		// key_val min limit
#define UNIFORMITY_GROUP2 70 			// screen uniformity in percent
...
#ifdef MEIZU_M79
	count += sprintf(buf + count, "79");
#else // MEIZU_M71
	count += sprintf(buf + count, "71");
#endif

	gtp_i2c_read_dbl_check(i2c_client_point, 0x81A1, &lcm_id, 1);
#ifdef MEIZU_M79
	if(lcm_id == 0x3C)
		count += sprintf(buf + count, "TRU");
#else
	if(lcm_id == 0xCA)
