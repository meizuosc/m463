...
//LiChao @2014.09.17 add for M71 LCM driver begin
#ifdef MEIZU_M71
extern LCM_DRIVER hx8394d_hd_dsi_vdo_truly_lcm_drv;
//s6d1fa2 command mode
extern LCM_DRIVER s6d1fa2_fhd_dsi_cmd_m71_tps65132_lcm_drv;
//nt35532
extern LCM_DRIVER nt35532_fhd_dsi_vdo_m71_tps65132_lcm_drv;
//s6d1fa2
extern LCM_DRIVER s6d1fa2_fhd_dsi_vdo_m71_tps65132_lcm_drv;
#endif
//LiChao @2014.09.17 add for M71 LCM driver end

LCM_DRIVER* lcm_driver_list[] = 
{
//LiChao @2014.09.17 add for M71 LCM driver begin
#ifdef MEIZU_M71
#if defined(HX8394D_HD_DSI_VDO_TRULY)
	&hx8394d_hd_dsi_vdo_truly_lcm_drv,
#endif	
//s6d1fa2 command mode
#if defined(S6D1FA2_FHD_DSI_CMD_M71_TPS65132)
	&s6d1fa2_fhd_dsi_cmd_m71_tps65132_lcm_drv,
#endif

//nt35532
#if defined(NT35532_FHD_DSI_VDO_M71_TPS65132)
	&nt35532_fhd_dsi_vdo_m71_tps65132_lcm_drv,
#endif

//s6d1fa2
#if defined(S6D1FA2_FHD_DSI_VDO_M71_TPS65132)
	&s6d1fa2_fhd_dsi_vdo_m71_tps65132_lcm_drv,
#endif	
