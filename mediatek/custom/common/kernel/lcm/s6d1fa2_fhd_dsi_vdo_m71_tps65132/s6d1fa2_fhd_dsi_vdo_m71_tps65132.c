...
static struct LCM_setting_table auo_init_code[] = {
	...
	//	{0xB0,    1,    {0x0e}},  
	//	{0xEB,    1,    {0x6C}}, // VGLK settiing,max FCh,min 00h;
...
static struct LCM_setting_table auo_slpin_dispoff[] = {
    ...
    {0xEC, 1, {0x01}},
/*
    {REGFLAG_DELAY, 1,  {}}, //2 wait 1 ms
     {0x28, 0, {}},
    {REGFLAG_DELAY, 10,  {}}, //2 wait 10 ms
    // Sleep Mode On
     {0x10, 0, {}}, 
     */
...
{
	lcm_print("[LK]s6d1fa2----tps65132---cmd   lcm_init\n");
#if 0
...
LCM_DRIVER s6d1fa2_fhd_dsi_vdo_m71_tps65132_lcm_drv = 
{
    .name			= "s6d1fa2_fhd_dsi_vdo_m71_tps65132",
