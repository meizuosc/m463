...
static int MMA8453Q_ReadCalibration(struct i2c_client *client, int dat[MMA8453Q_AXES_NUM])
{
    ...
    dat[obj->cvt.map[MMA8453Q_AXIS_X]] = obj->cvt.sign[MMA8453Q_AXIS_X]*(obj->offset[MMA8453Q_AXIS_X]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));
    dat[obj->cvt.map[MMA8453Q_AXIS_Y]] = obj->cvt.sign[MMA8453Q_AXIS_Y]*(obj->offset[MMA8453Q_AXIS_Y]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));
    dat[obj->cvt.map[MMA8453Q_AXIS_Z]] = obj->cvt.sign[MMA8453Q_AXIS_Z]*(obj->offset[MMA8453Q_AXIS_Z]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));                        
...
{  
	...
	//mul = obj->reso->sensitivity/mma8453q_offset_resolution.sensitivity;
	mul = mma8453q_offset_resolution.sensitivity/obj->reso->sensitivity;
	raw[MMA8453Q_AXIS_X] = obj->offset[MMA8453Q_AXIS_X]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA8453Q_AXIS_X];
	raw[MMA8453Q_AXIS_Y] = obj->offset[MMA8453Q_AXIS_Y]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA8453Q_AXIS_Y];
	raw[MMA8453Q_AXIS_Z] = obj->offset[MMA8453Q_AXIS_Z]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA8453Q_AXIS_Z];
...
static int MMA8453Q_WriteCalibration(struct i2c_client *client, int dat[MMA8453Q_AXES_NUM])
{
	...
	#if 0
	cali[MMA8453Q_AXIS_X] = cali[MMA8453Q_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[MMA8453Q_AXIS_Y] = cali[MMA8453Q_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[MMA8453Q_AXIS_Z] = cali[MMA8453Q_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	...
	obj->offset[MMA8453Q_AXIS_X] = (s8)(obj->cvt.sign[MMA8453Q_AXIS_X]*(cali[obj->cvt.map[MMA8453Q_AXIS_X]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
	obj->offset[MMA8453Q_AXIS_Y] = (s8)(obj->cvt.sign[MMA8453Q_AXIS_Y]*(cali[obj->cvt.map[MMA8453Q_AXIS_Y]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
	obj->offset[MMA8453Q_AXIS_Z] = (s8)(obj->cvt.sign[MMA8453Q_AXIS_Z]*(cali[obj->cvt.map[MMA8453Q_AXIS_Z]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
...
static int MMA8453Q_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
		#if 1
		obj->data[MMA8453Q_AXIS_X] = obj->data[MMA8453Q_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[MMA8453Q_AXIS_Y] = obj->data[MMA8453Q_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[MMA8453Q_AXIS_Z] = obj->data[MMA8453Q_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
		#endif
       ...
       unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
				cali[MMA8453Q_AXIS_X] = sensor_data.x;
				cali[MMA8453Q_AXIS_Y] = sensor_data.y;
				cali[MMA8453Q_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[MMA8453Q_AXIS_X];
			sensor_data.y = cali[MMA8453Q_AXIS_Y];
			sensor_data.z = cali[MMA8453Q_AXIS_Z];
