...
static int KXTF9_ReadCalibration(struct i2c_client *client, int dat[KXTF9_AXES_NUM])
{
    ...
    dat[obj->cvt.map[KXTF9_AXIS_X]] = obj->cvt.sign[KXTF9_AXIS_X]*(obj->offset[KXTF9_AXIS_X]*mul * GRAVITY_EARTH_1000 / obj->reso->sensitivity + obj->cali_sw[KXTF9_AXIS_X]);
    dat[obj->cvt.map[KXTF9_AXIS_Y]] = obj->cvt.sign[KXTF9_AXIS_Y]*(obj->offset[KXTF9_AXIS_Y]*mul * GRAVITY_EARTH_1000 / obj->reso->sensitivity + obj->cali_sw[KXTF9_AXIS_Y]);
    dat[obj->cvt.map[KXTF9_AXIS_Z]] = obj->cvt.sign[KXTF9_AXIS_Z]*(obj->offset[KXTF9_AXIS_Z]*mul * GRAVITY_EARTH_1000 / obj->reso->sensitivity + obj->cali_sw[KXTF9_AXIS_Z]);                        
...
{  
	...
	raw[KXTF9_AXIS_X] = obj->offset[KXTF9_AXIS_X]*mul * GRAVITY_EARTH_1000 / obj->reso->sensitivity + obj->cali_sw[KXTF9_AXIS_X];
	raw[KXTF9_AXIS_Y] = obj->offset[KXTF9_AXIS_Y]*mul * GRAVITY_EARTH_1000 / obj->reso->sensitivity + obj->cali_sw[KXTF9_AXIS_Y];
	raw[KXTF9_AXIS_Z] = obj->offset[KXTF9_AXIS_Z]*mul * GRAVITY_EARTH_1000 / obj->reso->sensitivity + obj->cali_sw[KXTF9_AXIS_Z];
...
#else
	obj->offset[KXTF9_AXIS_X] = (s8)(obj->cvt.sign[KXTF9_AXIS_X]*(cali[obj->cvt.map[KXTF9_AXIS_X]]) * obj->reso->sensitivity / GRAVITY_EARTH_1000/(divisor));
	obj->offset[KXTF9_AXIS_Y] = (s8)(obj->cvt.sign[KXTF9_AXIS_Y]*(cali[obj->cvt.map[KXTF9_AXIS_Y]]) * obj->reso->sensitivity / GRAVITY_EARTH_1000/(divisor));
	obj->offset[KXTF9_AXIS_Z] = (s8)(obj->cvt.sign[KXTF9_AXIS_Z]*(cali[obj->cvt.map[KXTF9_AXIS_Z]]) * obj->reso->sensitivity / GRAVITY_EARTH_1000/(divisor));
...
static int KXTF9_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
	#if 1
		obj->data[KXTF9_AXIS_X] = obj->data[KXTF9_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[KXTF9_AXIS_Y] = obj->data[KXTF9_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[KXTF9_AXIS_Z] = obj->data[KXTF9_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
	#endif	
       ...
       unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
			cali[KXTF9_AXIS_X] = sensor_data.x;
			cali[KXTF9_AXIS_Y] = sensor_data.y;
			cali[KXTF9_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[KXTF9_AXIS_X];
			sensor_data.y = cali[KXTF9_AXIS_Y];
			sensor_data.z = cali[KXTF9_AXIS_Z];
