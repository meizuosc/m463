...
static int MC3210_ReadCalibration(struct i2c_client *client, int dat[MC3210_AXES_NUM])
{
   ...
   dat[obj->cvt.map[MC3210_AXIS_X]] = obj->cvt.sign[MC3210_AXIS_X]*(obj->offset[MC3210_AXIS_X]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MC3210_AXIS_X]);
   dat[obj->cvt.map[MC3210_AXIS_Y]] = obj->cvt.sign[MC3210_AXIS_Y]*(obj->offset[MC3210_AXIS_Y]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MC3210_AXIS_Y]);
   dat[obj->cvt.map[MC3210_AXIS_Z]] = obj->cvt.sign[MC3210_AXIS_Z]*(obj->offset[MC3210_AXIS_Z]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MC3210_AXIS_Z]);                        
...
{  
	...
	raw[MC3210_AXIS_X] = obj->offset[MC3210_AXIS_X]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MC3210_AXIS_X];
	raw[MC3210_AXIS_Y] = obj->offset[MC3210_AXIS_Y]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MC3210_AXIS_Y];
	raw[MC3210_AXIS_Z] = obj->offset[MC3210_AXIS_Z]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MC3210_AXIS_Z];
...
static int MC3210_WriteCalibration(struct i2c_client *client, int dat[MC3210_AXES_NUM])
{
	...
	#if 0
	cali[MC3210_AXIS_X] = cali[MC3210_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[MC3210_AXIS_Y] = cali[MC3210_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[MC3210_AXIS_Z] = cali[MC3210_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	#endif		
	...
	GSE_LOG("NEWOFF: (%+3d %+3d %+3d): (%+3d %+3d %+3d) / (%+3d %+3d %+3d)\n", 
		...
		obj->cali_sw[MC3210_AXIS_X], obj->cali_sw[MC3210_AXIS_Y], obj->cali_sw[MC3210_AXIS_Z]);
#else
	obj->offset[MC3210_AXIS_X] = (s8)(obj->cvt.sign[MC3210_AXIS_X]*(cali[obj->cvt.map[MC3210_AXIS_X]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
	obj->offset[MC3210_AXIS_Y] = (s8)(obj->cvt.sign[MC3210_AXIS_Y]*(cali[obj->cvt.map[MC3210_AXIS_Y]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
	obj->offset[MC3210_AXIS_Z] = (s8)(obj->cvt.sign[MC3210_AXIS_Z]*(cali[obj->cvt.map[MC3210_AXIS_Z]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
...
static int MC3210_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
		#if 1
		obj->data[MC3210_AXIS_X] = obj->data[MC3210_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[MC3210_AXIS_Y] = obj->data[MC3210_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[MC3210_AXIS_Z] = obj->data[MC3210_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
		#endif
        #ifdef SW_CALIBRATION     
       ...
       unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
				cali[MC3210_AXIS_X] = sensor_data.x;
				cali[MC3210_AXIS_Y] = sensor_data.y;
				cali[MC3210_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[MC3210_AXIS_X];
			sensor_data.y = cali[MC3210_AXIS_Y];
			sensor_data.z = cali[MC3210_AXIS_Z];
