...
static int LIS33DE_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
	#if 1
		obj->data[LIS33DE_AXIS_X] = obj->data[LIS33DE_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[LIS33DE_AXIS_Y] = obj->data[LIS33DE_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[LIS33DE_AXIS_Z] = obj->data[LIS33DE_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
       ...
       unsigned long arg)       
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
				cali[LIS33DE_AXIS_X] = sensor_data.x;
				cali[LIS33DE_AXIS_Y] = sensor_data.y;
				cali[LIS33DE_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[LIS33DE_AXIS_X];
			sensor_data.y = cali[LIS33DE_AXIS_Y];
			sensor_data.z = cali[LIS33DE_AXIS_Z];
