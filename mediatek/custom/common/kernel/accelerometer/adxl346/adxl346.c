...
static int ADXL346_ReadCalibration(struct i2c_client *client, int dat[ADXL346_AXES_NUM])
{
    ...
    dat[obj->cvt.map[ADXL346_AXIS_X]] = obj->cvt.sign[ADXL346_AXIS_X]*(obj->offset[ADXL346_AXIS_X]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL346_AXIS_X]);
    dat[obj->cvt.map[ADXL346_AXIS_Y]] = obj->cvt.sign[ADXL346_AXIS_Y]*(obj->offset[ADXL346_AXIS_Y]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL346_AXIS_Y]);
    dat[obj->cvt.map[ADXL346_AXIS_Z]] = obj->cvt.sign[ADXL346_AXIS_Z]*(obj->offset[ADXL346_AXIS_Z]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL346_AXIS_Z]);                        
...
{  
	...
	mul = obj->reso->sensitivity/adxl346_offset_resolution.sensitivity;
	raw[ADXL346_AXIS_X] = obj->offset[ADXL346_AXIS_X]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL346_AXIS_X];
	raw[ADXL346_AXIS_Y] = obj->offset[ADXL346_AXIS_Y]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL346_AXIS_Y];
	raw[ADXL346_AXIS_Z] = obj->offset[ADXL346_AXIS_Z]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL346_AXIS_Z];
...
static int ADXL346_WriteCalibration(struct i2c_client *client, int dat[ADXL346_AXES_NUM])
{
	...
	obj->offset[ADXL346_AXIS_X] = (s8)(obj->cvt.sign[ADXL346_AXIS_X]*(cali[obj->cvt.map[ADXL346_AXIS_X]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
	obj->offset[ADXL346_AXIS_Y] = (s8)(obj->cvt.sign[ADXL346_AXIS_Y]*(cali[obj->cvt.map[ADXL346_AXIS_Y]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
	obj->offset[ADXL346_AXIS_Z] = (s8)(obj->cvt.sign[ADXL346_AXIS_Z]*(cali[obj->cvt.map[ADXL346_AXIS_Z]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
...
static int ADXL346_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
		#if 1
		obj->data[ADXL346_AXIS_X] = obj->data[ADXL346_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[ADXL346_AXIS_Y] = obj->data[ADXL346_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[ADXL346_AXIS_Z] = obj->data[ADXL346_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
		#endif
