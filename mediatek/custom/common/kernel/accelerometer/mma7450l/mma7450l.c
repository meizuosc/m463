...
static int MMA7450L_ReadCalibration(struct i2c_client *client, int dat[MMA7450L_AXES_NUM])
{
    ...
    dat[obj->cvt.map[MMA7450L_AXIS_X]] = obj->cvt.sign[MMA7450L_AXIS_X]*(obj->offset[MMA7450L_AXIS_X]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA7450L_AXIS_X]);
    dat[obj->cvt.map[MMA7450L_AXIS_Y]] = obj->cvt.sign[MMA7450L_AXIS_Y]*(obj->offset[MMA7450L_AXIS_Y]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA7450L_AXIS_Y]);
    dat[obj->cvt.map[MMA7450L_AXIS_Z]] = obj->cvt.sign[MMA7450L_AXIS_Z]*(obj->offset[MMA7450L_AXIS_Z]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA7450L_AXIS_Z]);                        
...
{  
    ...
    mul = mma7450l_offset_resolution.sensitivity/obj->reso->sensitivity;
    raw[MMA7450L_AXIS_X] = obj->offset[MMA7450L_AXIS_X]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA7450L_AXIS_X];
    raw[MMA7450L_AXIS_Y] = obj->offset[MMA7450L_AXIS_Y]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA7450L_AXIS_Y];
    raw[MMA7450L_AXIS_Z] = obj->offset[MMA7450L_AXIS_Z]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[MMA7450L_AXIS_Z];
...
static int MMA7450L_WriteCalibration(struct i2c_client *client, int dat[MMA7450L_AXES_NUM])
{
	...
	#if 0
	cali[MMA7450L_AXIS_X] = cali[MMA7450L_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[MMA7450L_AXIS_Y] = cali[MMA7450L_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[MMA7450L_AXIS_Z] = cali[MMA7450L_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
    ...
    obj->offset[MMA7450L_AXIS_X] = (s16)(obj->cvt.sign[MMA7450L_AXIS_X]*(cali[obj->cvt.map[MMA7450L_AXIS_X]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
    obj->offset[MMA7450L_AXIS_Y] = (s16)(obj->cvt.sign[MMA7450L_AXIS_Y]*(cali[obj->cvt.map[MMA7450L_AXIS_Y]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
    obj->offset[MMA7450L_AXIS_Z] = (s16)(obj->cvt.sign[MMA7450L_AXIS_Z]*(cali[obj->cvt.map[MMA7450L_AXIS_Z]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
...
static int MMA7450L_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
		#if 1
		obj->data[MMA7450L_AXIS_X] = obj->data[MMA7450L_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[MMA7450L_AXIS_Y] = obj->data[MMA7450L_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[MMA7450L_AXIS_Z] = obj->data[MMA7450L_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
		#endif
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			{   
				...
				#else
				cali[MMA7450L_AXIS_X] = sensor_data.x;
				cali[MMA7450L_AXIS_Y] = sensor_data.y;
				cali[MMA7450L_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[MMA7450L_AXIS_X];
			sensor_data.y = cali[MMA7450L_AXIS_Y];
			sensor_data.z = cali[MMA7450L_AXIS_Z];
