...
static int DMARD09_ReadCalibration(struct i2c_client *client, int dat[DMARD09_AXES_NUM])
{
    ...
    dat[obj->cvt.map[DMARD09_AXIS_X]] = obj->cvt.sign[DMARD09_AXIS_X]*(obj->offset[DMARD09_AXIS_X]*mul * obj->reso->sensitivity / GRAVITY_EARTH_1000 + obj->cali_sw[DMARD09_AXIS_X]);
    dat[obj->cvt.map[DMARD09_AXIS_Y]] = obj->cvt.sign[DMARD09_AXIS_Y]*(obj->offset[DMARD09_AXIS_Y]*mul * obj->reso->sensitivity / GRAVITY_EARTH_1000 + obj->cali_sw[DMARD09_AXIS_Y]);
    dat[obj->cvt.map[DMARD09_AXIS_Z]] = obj->cvt.sign[DMARD09_AXIS_Z]*(obj->offset[DMARD09_AXIS_Z]*mul * obj->reso->sensitivity / GRAVITY_EARTH_1000+ obj->cali_sw[DMARD09_AXIS_Z]);                        
...
{  
	...
	raw[DMARD09_AXIS_X] = obj->offset[DMARD09_AXIS_X]*mul * obj->reso->sensitivity / GRAVITY_EARTH_1000 + obj->cali_sw[DMARD09_AXIS_X];
	raw[DMARD09_AXIS_Y] = obj->offset[DMARD09_AXIS_Y]*mul * obj->reso->sensitivity / GRAVITY_EARTH_1000 + obj->cali_sw[DMARD09_AXIS_Y];
	raw[DMARD09_AXIS_Z] = obj->offset[DMARD09_AXIS_Z]*mul * obj->reso->sensitivity / GRAVITY_EARTH_1000 + obj->cali_sw[DMARD09_AXIS_Z];
...
#else
	obj->offset[DMARD09_AXIS_X] = (s8)(obj->cvt.sign[DMARD09_AXIS_X]*(cali[obj->cvt.map[DMARD09_AXIS_X]]) * obj->reso->sensitivity / GRAVITY_EARTH_1000/(divisor));
	obj->offset[DMARD09_AXIS_Y] = (s8)(obj->cvt.sign[DMARD09_AXIS_Y]*(cali[obj->cvt.map[DMARD09_AXIS_Y]]) * obj->reso->sensitivity / GRAVITY_EARTH_1000/(divisor));
	obj->offset[DMARD09_AXIS_Z] = (s8)(obj->cvt.sign[DMARD09_AXIS_Z]*(cali[obj->cvt.map[DMARD09_AXIS_Z]]) * obj->reso->sensitivity / GRAVITY_EARTH_1000/(divisor));
...
static int DMARD09_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
	#if 1
		obj->data[DMARD09_AXIS_X] = obj->data[DMARD09_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[DMARD09_AXIS_Y] = obj->data[DMARD09_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[DMARD09_AXIS_Z] = obj->data[DMARD09_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
	#endif	
       ...
       unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
			cali[DMARD09_AXIS_X] = sensor_data.x;
			cali[DMARD09_AXIS_Y] = sensor_data.y;
			cali[DMARD09_AXIS_Z] = sensor_data.z; 		  
