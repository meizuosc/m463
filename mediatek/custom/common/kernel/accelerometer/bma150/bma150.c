...
static int BMA150_ReadCalibration(struct i2c_client *client, int dat[BMA150_AXES_NUM])
{
    ...
    dat[obj->cvt.map[BMA150_AXIS_X]] = obj->cvt.sign[BMA150_AXIS_X]*(obj->offset[BMA150_AXIS_X]*mul * GRAVITY_EARTH_1000 / (obj->reso->sensitivity) + obj->cali_sw[BMA150_AXIS_X]);
    dat[obj->cvt.map[BMA150_AXIS_Y]] = obj->cvt.sign[BMA150_AXIS_Y]*(obj->offset[BMA150_AXIS_Y]*mul * GRAVITY_EARTH_1000 / (obj->reso->sensitivity) + obj->cali_sw[BMA150_AXIS_Y]);
    dat[obj->cvt.map[BMA150_AXIS_Z]] = obj->cvt.sign[BMA150_AXIS_Z]*(obj->offset[BMA150_AXIS_Z]*mul * GRAVITY_EARTH_1000 / (obj->reso->sensitivity) + obj->cali_sw[BMA150_AXIS_Z]);                        
...
{  
	...
	raw[BMA150_AXIS_X] = obj->offset[BMA150_AXIS_X]*mul * GRAVITY_EARTH_1000 / (obj->reso->sensitivity) + obj->cali_sw[BMA150_AXIS_X];
	raw[BMA150_AXIS_Y] = obj->offset[BMA150_AXIS_Y]*mul * GRAVITY_EARTH_1000 / (obj->reso->sensitivity) + obj->cali_sw[BMA150_AXIS_Y];
	raw[BMA150_AXIS_Z] = obj->offset[BMA150_AXIS_Z]*mul * GRAVITY_EARTH_1000 / (obj->reso->sensitivity) + obj->cali_sw[BMA150_AXIS_Z];
...
#else
	obj->offset[BMA150_AXIS_X] = (s8)(obj->cvt.sign[BMA150_AXIS_X]*(cali[obj->cvt.map[BMA150_AXIS_X]]) * (obj->reso->sensitivity) / GRAVITY_EARTH_1000/(divisor));
	obj->offset[BMA150_AXIS_Y] = (s8)(obj->cvt.sign[BMA150_AXIS_Y]*(cali[obj->cvt.map[BMA150_AXIS_Y]]) * (obj->reso->sensitivity) / GRAVITY_EARTH_1000/(divisor));
	obj->offset[BMA150_AXIS_Z] = (s8)(obj->cvt.sign[BMA150_AXIS_Z]*(cali[obj->cvt.map[BMA150_AXIS_Z]]) * (obj->reso->sensitivity) / GRAVITY_EARTH_1000/(divisor));
...
static int BMA150_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
		#if 1
		obj->data[BMA150_AXIS_X] = obj->data[BMA150_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[BMA150_AXIS_Y] = obj->data[BMA150_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[BMA150_AXIS_Z] = obj->data[BMA150_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
	#endif
       ...
       unsigned long arg)       
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
			cali[BMA150_AXIS_X] = sensor_data.x;
			cali[BMA150_AXIS_Y] = sensor_data.y;
			cali[BMA150_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[BMA150_AXIS_X];
			sensor_data.y = cali[BMA150_AXIS_Y];
			sensor_data.z = cali[BMA150_AXIS_Z];
