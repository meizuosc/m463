...
{  
	...
	raw[LSM303D_AXIS_X] = obj->offset[LSM303D_AXIS_X]*mul*GRAVITY_EARTH_1000/(obj->reso.sensitivity) + obj->cali_sw[LSM303D_AXIS_X];
	raw[LSM303D_AXIS_Y] = obj->offset[LSM303D_AXIS_Y]*mul*GRAVITY_EARTH_1000/(obj->reso.sensitivity) + obj->cali_sw[LSM303D_AXIS_Y];
	raw[LSM303D_AXIS_Z] = obj->offset[LSM303D_AXIS_Z]*mul*GRAVITY_EARTH_1000/(obj->reso.sensitivity) + obj->cali_sw[LSM303D_AXIS_Z];
...
static int lsm303d_ReadCalibration(struct i2c_client *client, int dat[LSM303D_AXES_NUM])
{
   ...
   dat[obj->cvt.map[LSM303D_AXIS_X]] = obj->cvt.sign[LSM303D_AXIS_X]*(obj->offset[LSM303D_AXIS_X]*mul*GRAVITY_EARTH_1000/(obj->reso.sensitivity) + obj->cali_sw[LSM303D_AXIS_X]);
   dat[obj->cvt.map[LSM303D_AXIS_Y]] = obj->cvt.sign[LSM303D_AXIS_Y]*(obj->offset[LSM303D_AXIS_Y]*mul*GRAVITY_EARTH_1000/(obj->reso.sensitivity) + obj->cali_sw[LSM303D_AXIS_Y]);
   dat[obj->cvt.map[LSM303D_AXIS_Z]] = obj->cvt.sign[LSM303D_AXIS_Z]*(obj->offset[LSM303D_AXIS_Z]*mul*GRAVITY_EARTH_1000/(obj->reso.sensitivity) + obj->cali_sw[LSM303D_AXIS_Z]);                        
...
#define LSM303D_AXIS_Z          2
	...
	#if 0
	cali[LSM303D_AXIS_X] = cali[LSM303D_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso.sensitivity;
	cali[LSM303D_AXIS_Y] = cali[LSM303D_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso.sensitivity;
	cali[LSM303D_AXIS_Z] = cali[LSM303D_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso.sensitivity;
	#endif		
	...
	GSE_LOG("NEWOFF: (%+3d %+3d %+3d): (%+3d %+3d %+3d) / (%+3d %+3d %+3d)\n", 
		...
		obj->cali_sw[LSM303D_AXIS_X], obj->cali_sw[LSM303D_AXIS_Y], obj->cali_sw[LSM303D_AXIS_Z]);
#else
	obj->offset[LSM303D_AXIS_X] = (s8)(obj->cvt.sign[LSM303D_AXIS_X]*(cali[obj->cvt.map[LSM303D_AXIS_X]])*(obj->reso.sensitivity)/GRAVITY_EARTH_1000/(divisor));
	obj->offset[LSM303D_AXIS_Y] = (s8)(obj->cvt.sign[LSM303D_AXIS_Y]*(cali[obj->cvt.map[LSM303D_AXIS_Y]])*(obj->reso.sensitivity)/GRAVITY_EARTH_1000/(divisor));
	obj->offset[LSM303D_AXIS_Z] = (s8)(obj->cvt.sign[LSM303D_AXIS_Z]*(cali[obj->cvt.map[LSM303D_AXIS_Z]])*(obj->reso.sensitivity)/GRAVITY_EARTH_1000/(divisor));
...
static int lsm303d_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
		#if 1
		obj->data[LSM303D_AXIS_X] = obj->data[LSM303D_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso.sensitivity;
		obj->data[LSM303D_AXIS_Y] = obj->data[LSM303D_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso.sensitivity;
		obj->data[LSM303D_AXIS_Z] = obj->data[LSM303D_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso.sensitivity;		
		#endif
       ...
       unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
				cali[LSM303D_AXIS_X] = sensor_data.x;
				cali[LSM303D_AXIS_Y] = sensor_data.y;
				cali[LSM303D_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[LSM303D_AXIS_X];
			sensor_data.y = cali[LSM303D_AXIS_Y];
			sensor_data.z = cali[LSM303D_AXIS_Z];
