...
static int ADXL345_ReadCalibration(struct i2c_client *client, int dat[ADXL345_AXES_NUM])
{
    ...
    dat[obj->cvt.map[ADXL345_AXIS_X]] = obj->cvt.sign[ADXL345_AXIS_X]*(obj->offset[ADXL345_AXIS_X]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL345_AXIS_X]);
    dat[obj->cvt.map[ADXL345_AXIS_Y]] = obj->cvt.sign[ADXL345_AXIS_Y]*(obj->offset[ADXL345_AXIS_Y]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL345_AXIS_Y]);
    dat[obj->cvt.map[ADXL345_AXIS_Z]] = obj->cvt.sign[ADXL345_AXIS_Z]*(obj->offset[ADXL345_AXIS_Z]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL345_AXIS_Z]);                        
...
{  
	...
	mul = obj->reso->sensitivity/adxl345_offset_resolution.sensitivity;
	raw[ADXL345_AXIS_X] = obj->offset[ADXL345_AXIS_X]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL345_AXIS_X];
	raw[ADXL345_AXIS_Y] = obj->offset[ADXL345_AXIS_Y]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL345_AXIS_Y];
	raw[ADXL345_AXIS_Z] = obj->offset[ADXL345_AXIS_Z]*mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[ADXL345_AXIS_Z];
...
static int ADXL345_WriteCalibration(struct i2c_client *client, int dat[ADXL345_AXES_NUM])
{
	...
	obj->offset[ADXL345_AXIS_X] = (s8)(obj->cvt.sign[ADXL345_AXIS_X]*(cali[obj->cvt.map[ADXL345_AXIS_X]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
	obj->offset[ADXL345_AXIS_Y] = (s8)(obj->cvt.sign[ADXL345_AXIS_Y]*(cali[obj->cvt.map[ADXL345_AXIS_Y]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
	obj->offset[ADXL345_AXIS_Z] = (s8)(obj->cvt.sign[ADXL345_AXIS_Z]*(cali[obj->cvt.map[ADXL345_AXIS_Z]])*(obj->reso->sensitivity)/GRAVITY_EARTH_1000/(divisor));
...
static int ADXL345_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
	#if 1
		obj->data[ADXL345_AXIS_X] = obj->data[ADXL345_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[ADXL345_AXIS_Y] = obj->data[ADXL345_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[ADXL345_AXIS_Z] = obj->data[ADXL345_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
		#endif
       ...
       unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
				cali[ADXL345_AXIS_X] = sensor_data.x;
				cali[ADXL345_AXIS_Y] = sensor_data.y;
				cali[ADXL345_AXIS_Z] = sensor_data.z; 		  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[ADXL345_AXIS_X];
			sensor_data.y = cali[ADXL345_AXIS_Y];
			sensor_data.z = cali[ADXL345_AXIS_Z];
