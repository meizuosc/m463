...
static int STK8BA22_ReadCalibration(struct i2c_client *client, int dat[STK8BA22_AXES_NUM])
{
    ...
    dat[obj->cvt.map[STK8BA22_AXIS_X]] = obj->cvt.sign[STK8BA22_AXIS_X]*(obj->offset[STK8BA22_AXIS_X]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));
    dat[obj->cvt.map[STK8BA22_AXIS_Y]] = obj->cvt.sign[STK8BA22_AXIS_Y]*(obj->offset[STK8BA22_AXIS_Y]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));
    dat[obj->cvt.map[STK8BA22_AXIS_Z]] = obj->cvt.sign[STK8BA22_AXIS_Z]*(obj->offset[STK8BA22_AXIS_Z]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));                        
...
{  
	...
	mul = stk8ba22_offset_resolution.sensitivity/obj->reso->sensitivity;
	raw[STK8BA22_AXIS_X] = obj->offset[STK8BA22_AXIS_X]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[STK8BA22_AXIS_X];
	raw[STK8BA22_AXIS_Y] = obj->offset[STK8BA22_AXIS_Y]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[STK8BA22_AXIS_Y];
	raw[STK8BA22_AXIS_Z] = obj->offset[STK8BA22_AXIS_Z]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity) + obj->cali_sw[STK8BA22_AXIS_Z];
...
static int STK8BA22_WriteCalibration(struct i2c_client *client, int dat[STK8BA22_AXES_NUM])
{
	...
	#if 0
	cali[STK8BA22_AXIS_X] = cali[STK8BA22_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[STK8BA22_AXIS_Y] = cali[STK8BA22_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[STK8BA22_AXIS_Z] = cali[STK8BA22_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	...
	obj->offset[STK8BA22_AXIS_X] = (s8)(obj->cvt.sign[STK8BA22_AXIS_X]*(cali[obj->cvt.map[STK8BA22_AXIS_X]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
	obj->offset[STK8BA22_AXIS_Y] = (s8)(obj->cvt.sign[STK8BA22_AXIS_Y]*(cali[obj->cvt.map[STK8BA22_AXIS_Y]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
	obj->offset[STK8BA22_AXIS_Z] = (s8)(obj->cvt.sign[STK8BA22_AXIS_Z]*(cali[obj->cvt.map[STK8BA22_AXIS_Z]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
...
static int STK8BA22_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
	#if 1
		obj->data[STK8BA22_AXIS_X] = obj->data[STK8BA22_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[STK8BA22_AXIS_Y] = obj->data[STK8BA22_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[STK8BA22_AXIS_Z] = obj->data[STK8BA22_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
	#endif
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			{   
				...
				#else
				cali[STK8BA22_AXIS_X] = sensor_data.x;
				cali[STK8BA22_AXIS_Y] = sensor_data.y;
				cali[STK8BA22_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[STK8BA22_AXIS_X];
			sensor_data.y = cali[STK8BA22_AXIS_Y];
			sensor_data.z = cali[STK8BA22_AXIS_Z];
