...
static int BMA255_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
	#if 1
		databuf[BMA255_AXIS_X] = databuf[BMA255_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		databuf[BMA255_AXIS_Y] = databuf[BMA255_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		databuf[BMA255_AXIS_Z] = databuf[BMA255_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
#endif
