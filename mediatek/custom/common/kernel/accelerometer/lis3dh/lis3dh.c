...
static int LIS3DH_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
		/********************************************/
		obj->data[LIS3DH_AXIS_X] = obj->data[LIS3DH_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[LIS3DH_AXIS_Y] = obj->data[LIS3DH_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
		obj->data[LIS3DH_AXIS_Z] = obj->data[LIS3DH_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	/**************************************************/
