...
static ssize_t KXTE9_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	#if 1
		obj->data[KXTE9_AXIS_X] = obj->data[KXTE9_AXIS_X] * GRAVITY_EARTH_1000 / KXTE9_SENSITIVITY;
		obj->data[KXTE9_AXIS_Y] = obj->data[KXTE9_AXIS_Y] * GRAVITY_EARTH_1000 / KXTE9_SENSITIVITY;
		obj->data[KXTE9_AXIS_Z] = obj->data[KXTE9_AXIS_Z] * GRAVITY_EARTH_1000 / KXTE9_SENSITIVITY;	
#endif
       ...
       unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			#else
			cali[KXTE9_AXIS_X] = sensor_data.x;
			cali[KXTE9_AXIS_Y] = sensor_data.y;
			cali[KXTE9_AXIS_Z] = sensor_data.z;			  
		...
		case GSENSOR_IOCTL_GET_CALI:
			...
			#else
			sensor_data.x = cali[KXTE9_AXIS_X];
			sensor_data.y = cali[KXTE9_AXIS_Y];
			sensor_data.z = cali[KXTE9_AXIS_Z];
