...
static int STK8BA50_ReadCalibration(struct i2c_client *client, int dat[STK8BA50_AXES_NUM])
{
    ...
    dat[obj->cvt.map[STK8BA50_AXIS_X]] = obj->cvt.sign[STK8BA50_AXIS_X]*(obj->offset[STK8BA50_AXIS_X]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));
    dat[obj->cvt.map[STK8BA50_AXIS_Y]] = obj->cvt.sign[STK8BA50_AXIS_Y]*(obj->offset[STK8BA50_AXIS_Y]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));
    dat[obj->cvt.map[STK8BA50_AXIS_Z]] = obj->cvt.sign[STK8BA50_AXIS_Z]*(obj->offset[STK8BA50_AXIS_Z]/mul*GRAVITY_EARTH_1000/(obj->reso->sensitivity));                        
...
static int STK8BA50_WriteCalibration(struct i2c_client *client, int dat[STK8BA50_AXES_NUM])
{
	...
	#if 0
	cali[STK8BA50_AXIS_X] = cali[STK8BA50_AXIS_X] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[STK8BA50_AXIS_Y] = cali[STK8BA50_AXIS_Y] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	cali[STK8BA50_AXIS_Z] = cali[STK8BA50_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;
	...
	obj->offset[STK8BA50_AXIS_X] = (s8)(obj->cvt.sign[STK8BA50_AXIS_X]*(cali[obj->cvt.map[STK8BA50_AXIS_X]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
	obj->offset[STK8BA50_AXIS_Y] = (s8)(obj->cvt.sign[STK8BA50_AXIS_Y]*(cali[obj->cvt.map[STK8BA50_AXIS_Y]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
	obj->offset[STK8BA50_AXIS_Z] = (s8)(obj->cvt.sign[STK8BA50_AXIS_Z]*(cali[obj->cvt.map[STK8BA50_AXIS_Z]])*(divisor)*(obj->reso->sensitivity)/GRAVITY_EARTH_1000);
