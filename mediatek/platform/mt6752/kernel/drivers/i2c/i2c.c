...
static int i2c_get_md32_semaphore(mt_i2c *i2c)
{
	...
	// BSP Modified by wpb@meizu.com on 2014/11/17, according to ALPS01822551 and #116238
#ifdef MEIZU_M71
	return 0;
#endif
	// BSP end
...
{
  #ifndef MEIZU_M71		//start: close i2c error dump info, by yubin, 2014.09.23
  //I2CFUC();
