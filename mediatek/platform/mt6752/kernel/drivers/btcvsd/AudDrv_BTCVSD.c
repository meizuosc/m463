...
static volatile kal_uint32 *bt_hw_REG_PACKET_W, *bt_hw_REG_PACKET_R, *bt_hw_REG_CONTROL, *bt_cvsd_mask_CONTROL;
...
static void Disable_CVSD_Wakeup(void)
{
    ...
    *INFRA_MISC_REGISTER |= 0x00000800;
	#else
    volatile kal_uint32 *INFRA_MISC_REGISTER = (volatile kal_uint32 *)(bt_cvsd_mask_CONTROL);
    *INFRA_MISC_REGISTER |= 0x00000800;	
	#endif
    printk("Disable_CVSD_Wakeup,bt_cvsd_mask_CONTROL=0x%x \n",bt_cvsd_mask_CONTROL);
}
...
static void Enable_CVSD_Wakeup(void)
{
    ...
    *INFRA_MISC_REGISTER &= ~(0x00000800);
	#endif
    printk("Enable_CVSD_Wakeup,bt_cvsd_mask_CONTROL=0x%x \n",bt_cvsd_mask_CONTROL);
}
...
static int AudDrv_btcvsd_probe(struct platform_device *dev)
{
	...
	AP_INFRA_ADDRESS = ioremap_nocache(AUDIO_INFRA_BASE , 0x1000);
	bt_cvsd_mask_CONTROL = (volatile kal_uint32 *)(AP_INFRA_ADDRESS + 0x0F00);
