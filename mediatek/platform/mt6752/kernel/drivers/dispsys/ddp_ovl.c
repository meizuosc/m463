...
//lichao@20141112 patch mtk ALPS01808354 end			
		...
		break;
	case 1:
//lichao@20141112 patch mtk ALPS01808354 	
...
//lichao@20141112 patch mtk ALPS01808354 end
    ...
    if(idx==0)
    {
		...
		{
		    if(DISP_REG_GET(DISP_REG_OVL_RDMA0_MEM_GMC_SETTING+layer_offset)!=0x6070) //lichao@20141112 patch mtk ALPS01808354 add
		        DISP_REG_SET(handle, DISP_REG_OVL_RDMA0_MEM_GMC_SETTING+layer_offset, 0x6070);
		}
		else
		{
            if(DISP_REG_GET(DISP_REG_OVL_RDMA0_MEM_GMC_SETTING+layer_offset)!=0x50FF)//lichao@20141112 patch mtk ALPS01808354 add
			...
			void *handle)
{
	...
	int layer_enable;//lichao@20141112 patch mtk ALPS01808354 add
	...
	layer_enable = 0;//lichao@20141112 patch mtk ALPS01808354 add
