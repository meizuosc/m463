...
#include "ddp_drv.h"
#include "ddp_ovl.h"
//lichao@20141112 patch mtk ALPS01808354 begin
#include "ddp_reg.h"
#include "ddp_debug.h"
//lichao@20141112 patch mtk ALPS01808354 end
...
#include <mach/mt_spm.h>  // for sodi reg addr define//lichao@20141112 patch mtk ALPS01808354 add
...
// Config cmdq_handle_config_esd
extern unsigned int gESDEnableSODI;//lichao@20141112 patch mtk ALPS01808354 add
...
//lichao@20141112 patch mtk ALPS01808354 end	
	...
	// 5. trigger path
	cmdqRecClearEventToken(pgc->cmdq_handle_config_esd ,CMDQ_EVENT_MUTEX0_STREAM_EOF);//lichao@20141112 patch mtk ALPS01808354 add
...
int primary_display_esd_check(void)
{
	...
	_primary_path_esd_check_lock();//lichao@20141112 patch mtk ALPS01808354 
...
destory_cmdq:
	...
	_primary_path_esd_check_unlock();//lichao@20141112 patch mtk ALPS01808354 
	return ret;
...
//lichao@20141112 patch mtk ALPS01808354 vbegin
#if 0	
	if(primary_display_is_video_mode())
	{
		spm_enable_sodi(0);
...
int primary_display_init(char *lcm_name, unsigned int lcm_fps)
{
	...
	mutex_init(&(pgc->esd_check_lock));//lichao@20141112 patch mtk ALPS01808354 
#ifdef DISP_SWITCH_DST_MODE
