...
/**********************************************************
  ...
  *********************************************************/
#if 0
static int bq24296_notifier_event(struct notifier_block *this, unsigned long event, void *ptr)
{
...
void bq24296_set_en_boost(kal_uint32 val)
{
    kal_uint32 ret=0;

    ret=bq24296_config_interface(   (kal_uint8)(bq24296_CON1),
                                    (kal_uint8)(val),
                                    (kal_uint8)(CON1_EN_BOOST_MASK),
                                    (kal_uint8)(CON1_EN_BOOST_SHIFT)
                                    );
}
...
kal_uint32 bq24296_get_charger_type(void)
{
    kal_uint32 vbus_stat = 0;
    vbus_stat = bq24296_get_vbus_stat();
...
#if 0
    charger_notifier.notifier_call = bq24296_notifier_event;
