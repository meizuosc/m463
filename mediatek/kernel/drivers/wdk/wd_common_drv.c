...
{
    seq_printf(s,"mode interval timeout enable kick_bit check_bit online_bit\n%-4d %-9d %-8d %-7d 0x%08lx 0x%08x 0x%08lx\n", g_wk_wdt_mode, g_kinterval, g_timeout, g_enable, kick_bit, cpus_kick_bit, cpu_online_mask->bits[0]);
    return 0;
}
