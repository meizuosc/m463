...
//#ifndef Flyme_EDIT
//#guomateng@mediatek.Driver.add for load modem firmware by hardware info
/*
#  return value:
...
#define IS_LWG(type)	(((type) & 0x03) == 1? true:false)
#define IS_LTG(type)	(((type) & 0x03) == 2? true:false)
//#endif /*Flyme_EDIT*/
