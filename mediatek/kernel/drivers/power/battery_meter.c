...
#ifdef MEIZU_M71
	#ifdef MEIZU_M79
        /* M79 will Support ATL and SONY battery, ATL:0; SONY:1*/
	#ifdef MTK_MULTI_BAT_PROFILE_SUPPORT
    /* Cmax */
        kal_int32 g_Q_MAX_POS_50[] = {2343, 2476};
        kal_int32 g_Q_MAX_POS_25[] = {2353, 2460};
        kal_int32 g_Q_MAX_POS_0[] = {2040, 2317};
        kal_int32 g_Q_MAX_NEG_10[] = {2033, 2389};

    /* Cmax 400*/
        kal_int32 g_Q_MAX_POS_50_H_CURRENT[] = {2324, 2458};
        kal_int32 g_Q_MAX_POS_25_H_CURRENT[] = {2322, 2451};
        kal_int32 g_Q_MAX_POS_0_H_CURRENT[] = {1717, 2301};
        kal_int32 g_Q_MAX_NEG_10_H_CURRENT[] = {1212, 2281};
	#endif
	#else
        /* M71 will Support ATL and SONY battery, ATL:0; SONY:1*/
    #ifdef MTK_MULTI_BAT_PROFILE_SUPPORT
    /* Cmax */
        kal_int32 g_Q_MAX_POS_50[] = {2921, 2994};// {3059, 3136};
        kal_int32 g_Q_MAX_POS_25[] = {2931, 2967};// {3070, 3107};
        kal_int32 g_Q_MAX_POS_0[] = {2836, 2836};// {2972, 2970};
        kal_int32 g_Q_MAX_NEG_10[] = {2622, 2685};//{2746, 2812};

    /* Cmax 400*/
        kal_int32 g_Q_MAX_POS_50_H_CURRENT[] = {3046, 3111};
        kal_int32 g_Q_MAX_POS_25_H_CURRENT[] = {3047, 3079};
        kal_int32 g_Q_MAX_POS_0_H_CURRENT[] = {2765, 2817};
        kal_int32 g_Q_MAX_NEG_10_H_CURRENT[] = {2225, 2363};
    #endif
	#endif
#endif
...
#elif defined(MTK_GET_BATTERY_ID_BY_PMICADC)
...
int get_bat_id_volt(int times)
{
        ...
        ret = PMIC_IMM_GetOneChannelValue(AUX_ADCVIN0_MD,times,1);
...
void fgauge_construct_battery_profile_init(void)
{
	...
	for (i=0; i< PROFILE_SIZE; i++) {
		...
		for (j=0; j*2 <= 100; j++) {
			...
			/* 2014-9-28 by Yin ShunQing, in order to close log print start */
			#ifdef MEIZU_M71
			bm_print(BM_LOG_CRTI, "new battery_profile[%d,%d] <%d,%d>\n", i, j, (temp_profile_p + j)->percentage, (temp_profile_p + j)->voltage);
			#endif
			/* 2014-9-28 by Yin ShunQing, in order to close log print end */
		}
...
static ssize_t show_FG_g_fg_dbg_bat_type(struct device *dev,struct device_attribute *attr, char *buf)
{
    ...
    bm_print(BM_LOG_CRTI, "[FG] g_fg_dbg_battery_type : %d\n", g_fg_battery_id);
    return sprintf(buf, "%s\n", g_fg_battery_id==0 ? "ATL":"SONY");
}
