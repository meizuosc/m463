...
#ifdef MEIZU_M71
#ifdef MEIZU_M79	
#define CHARGER_CURRENT_1_2A_THRESHOLD 4820
#define CHARGER_CURRENT_1_5A_THRESHOLD 4900
#else
#define CHARGER_CURRENT_1A_THRESHOLD 4750
#define CHARGER_CURRENT_1_2A_THRESHOLD 4830
extern	unsigned int mz_get_operator_type(void) ;
